...
// 3. Password life
document.getElementById('BtnUpLife').addEventListener('click', () => incrementar('PassLife'));
document.getElementById('BtnDownLife').addEventListener('click', () => decrementar('PassLife'));
document.getElementById('BtnEnd').addEventListener('click', function() {
    ...
    const SecMod = document.getElementById('SecMod').checked ? 'Sí' : 'No';
    const A2F = document.getElementById('A2F').checked ? 'Sí' : 'No';
    const PassLife = document.getElementById('PassLife').value;
